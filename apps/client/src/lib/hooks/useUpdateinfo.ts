...
import { AuthActionType, NotificationType } from "../reducers/authreducer";
import { FormEvent } from "react";

/**
 * @description This hook is used to update the user profile
 * @returns  {BannerOnChange, uploadProfilePhoto, UpdateProfile, UpdateEmail, UpdatePassword, DeleteProfilePhoto}
 * @example
 * const {BannerOnChange, uploadProfilePhoto, UpdateProfile, UpdateEmail, UpdatePassword, DeleteProfilePhoto} = useUpdateinfo()
 */
const useUpdateinfo = () => {
	 ...
	 *
	 */
	const BannerOnChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
